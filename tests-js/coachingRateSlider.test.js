...
describe("coaching.js renderRateSlider", () => {
  ...
  it("shows both kg and %BW for the weekly and monthly rate", () => {
    ...
    expect(el.querySelector("#pc-rate-pct-week").textContent).toBe("1.00");
    expect(el.querySelector("#pc-rate-kg-month").textContent).toBe("4.3");
    expect(el.querySelector("#pc-rate-pct-month").textContent).toBe("4.35");
  });
